...
public class HostOrNot {

	  public static final String KEY_ROWID="_id";
	  public static final String KEY_NAME="persons_name";
	  public static final String KEY_HOTNESS="persons_hotness";
	  
	  private static final String DATABASE_NAME="HostOrNotdb";
	  ...
	  public HostOrNot(Context c){
		  ourContext=c;
	  }
	  public HostOrNot open()throws SQLException
	  {
	...
	public void upddateEntry(long lRow, String mName, String mHostness)throws SQLException {
		// TODO Auto-generated method stub
		ContentValues cvUpdate=new ContentValues();
		cvUpdate.put(KEY_NAME,mName);
		cvUpdate.put(KEY_HOTNESS,mHostness);
